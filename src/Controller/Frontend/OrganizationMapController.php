 ...
 */
class OrganizationMapController extends AbstractController
{
    ...
    /**
     * @Route(name="_app_organizations_map", path="/mapa/utulky-{slug}")
     *
     * @param Request $request
     * @param string|null $slug
     * @return Response
     */
    public function mapAction(Request $request, ?string $slug = null): Response
    {
